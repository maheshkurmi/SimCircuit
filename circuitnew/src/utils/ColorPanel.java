...
import common.JSliderWithTextField;
...
public class ColorPanel extends JPanel {
	...
	public ColorPanel(Color initialColor, boolean showAlpha) {
		...
		// setup the labels
		this.lblRed = new JLabel("Red", Icons.ABOUT, JLabel.LEFT);
		this.lblGreen = new JLabel("Green", Icons.ABOUT, JLabel.LEFT);
		this.lblBlue = new JLabel("Blue", Icons.ABOUT, JLabel.LEFT);
		this.lblAlpha = new JLabel("Alpha", Icons.ABOUT, JLabel.LEFT);
		
		this.lblRed.setToolTipText("panel.color.red.tooltip");
		this.lblGreen.setToolTipText("panel.color.green.tooltip");
		this.lblBlue.setToolTipText("panel.color.blue.tooltip");
		this.lblAlpha.setToolTipText("panel.color.alpha.tooltip");
